...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const fetchAdminData = async () => {
        try {
            const vRes = await axios.get('/api/admin/vendors', { headers: { Authorization: `Bearer ${user.token}` } });
  ...
  const addMembership = async (e) => {
      e.preventDefault();
      try {
          await axios.post('/api/admin/memberships', { vendorId, duration }, { headers: { Authorization: `Bearer ${user.token}` } });
  ...
  const changePassword = async (e) => {
      e.preventDefault();
      try {
          await axios.put('/api/admin/change-password', { newPassword }, { headers: { Authorization: `Bearer ${user.token}` } });
