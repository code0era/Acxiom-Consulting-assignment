...
export default function RequestItem() {
  ...
  const [inquiries] = useState([
    { id: 'RQ-774', user: 'Shubham Yadav', subject: 'Custom Floral Arrangement', date: '4/7/2026', type: 'Specialty Item' },
    { id: 'RQ-812', user: 'Ankit Sharma', subject: 'Vegan Catering Menu Request', date: '4/7/2026', type: 'Menu Customization' },
    { id: 'RQ-905', user: 'Priya Singh', subject: 'Outdoor Lighting Setup Inquiry', date: '4/6/2026', type: 'Site Visit' }
  ]);
